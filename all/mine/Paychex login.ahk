...
; Launches this script when you press Ctrl+Numpad0
...
Run, "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" --profile-directory="Profile 3" --new-window https://paychex.centralservers.com
